 ...
 * computed technical analysis structures mapped to the {@link FinancialIndicators} model.
...
public class BaseFinancialIndicatorsAnomaliesDetectionService extends BaseAnomaliesDetectionService<FinancialIndicators> {
     ...
     * underlying baseline historical data (zeros), securing an accurate model training distribution.
     *
